const products = [
	...
	{
		_id: '8',
		name: 'PETKIT Pura X Self-Cleaning Cat Litter Box xSecure/Odor Removal/APP Control Automatic Cat Littler Box for Multiple Cats',
		image: '/images/literbox.png',
		description:
			'Secure: Thermal sensor, infrared sensor, weight sensor, anti-pinch infrared sensors, smart detection, remote alerts, accident protection system.Compatible with multiple cat litters: Special designed filter fits both plant litters and bentonite litters. And all other kinds of cat litters (except CRYSTAL CAT LITTERS).Odor removal: Independently researched and developed purifying liquid removes unpleasant odors and formaldehyde. No unpleasant smell.',
		brand: 'PetKit',
		category: 'Cats',
		price: '599.0',
		countInStock: 5,
